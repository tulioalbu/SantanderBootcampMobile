...
// jogos ou atividades que a envolvam para brincar com seus amiguinhos.
...
// na segunda posição uma letra maiúscula ou minúscula do alfabeto
...
fun main(args: Array<String>) {
    ...
    for (i in 1..N) {
        ...
        if (N1.equals(N2)) {
            ...
            if (x.uppercase(Locale.getDefault()) == x) {
                println(N2 - N1)
            } else {
                println(N1 + N2)
            }
